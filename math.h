...
void matrix_transpose(Matrix *source, Matrix *target) {
...
void vector_project(Vector3D *source, s32 projection_distance, s32 camera_distance,
                    Vector2D *target) {
  s32 div = (projection_distance << 16) / (source->z + camera_distance);
